...
// api
import { GET_CLIENTS } from 'api/GraphQL/quaries';
// components
import Filters from 'components/Client/Clients/Filters';
import ClientAreaTable from 'components/Client/Clients/Table';
// constants
...
const ClientArea = () => {
  ...
  const { data, loading, error } = useQuery<CrmGatewayQuery>(GET_CLIENTS, { variables: queryVariables });
