    ...
    {() => (
      <Form className="form">
        <div className="custom-wrapper form-wrapper">
          ...
          <FormControlTextInput isError labelText="Birthday" mask="99.99.9999" name="birthday" placeholder="00.00.0000" />
          <FormControlTextInput isError labelText="Phone" mask="+7(999)999-99-99" name="phone" placeholder="+7(___) ___-__-__" />
          <FormControlTextInput isError labelText="Passport" mask="99 99 999999" name="passport" placeholder="00 00 000000" />
